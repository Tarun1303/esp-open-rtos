...
REPORT=/tmp/fl-v01013f-agent-runtime-proof.txt
OUTPUT=/tmp/fl-v01013f-codex-output.txt
...
fail() {
  ...
  trap - ERR
  {
    echo FOURTH_LAW_AGENT_RUNTIME_PROOF_V0_10_13F_FAILED
...
{
  echo FOURTH_LAW_AGENT_RUNTIME_PROOF_V0_10_13F_READY
...
trap - ERR
echo FOURTH_LAW_AGENT_RUNTIME_PROOF_V0_10_13F_DISPATCHED
