...
grep -q 'Project Overview' "$CONTROL/app/static/codex.html"
grep -q 'Architecture & Fundamentals' "$CONTROL/app/static/codex.html"
grep -q 'Ordinary Coding Threads' "$CONTROL/app/static/codex.html"
